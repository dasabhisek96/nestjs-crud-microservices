...
// import { Product } from '@/entities/product.entity'; // Ensure this is the correct path to your User entity
...
//         try {
//             const productRepository = AppDataSource.getRepository(Product);
//             const product = productRepository.create(payload); // Create an instance
//             return await productRepository.save(product); // Save it to the database
//         } catch (error: any) {
//             console.error(`[ProductDAO_addProduct] Error: `, error);
//             throw new Error(error?.message || 'Failed to add product');
//         }
